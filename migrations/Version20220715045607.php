 ...
 */
final class Version20220715045607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dish (id INT NOT NULL, restaurant_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1024) NOT NULL, price INT NOT NULL, weight INT NOT NULL, image VARCHAR(1024) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE restaurant_review (id INT NOT NULL, reviewer_id INT NOT NULL, rating DOUBLE PRECISION NOT NULL, updated TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, text VARCHAR(2048) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE "user" ADD status VARCHAR(1) NOT NULL');
