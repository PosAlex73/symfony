...
class __TwigTemplate_4f61b4d8596cdf31a723acd608d7fbcc extends Template
{
    private $source;
    private $macros = [];
...
Symfony Twig Bridge to ensure that all applications building backends with EasyAdmin
use the same version of the templates, even those still using Symfony 4.4.
", "@EasyAdmin/symfony-form-themes/README.txt", "/var/html/symfony/vendor/easycorp/easyadmin-bundle/src/Resources/views/symfony-form-themes/README.txt");
    }
}
