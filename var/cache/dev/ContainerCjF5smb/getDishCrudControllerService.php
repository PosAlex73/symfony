...
class getDishCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/Admin/DishCrudController.php';

        $container->services['App\\Controller\\Admin\\DishCrudController'] = $instance = new \App\Controller\Admin\DishCrudController();

        $instance->setContainer(($container->privates['.service_locator.GymbEAg'] ?? $container->load('get_ServiceLocator_GymbEAgService'))->withContext('App\\Controller\\Admin\\DishCrudController', $container));
