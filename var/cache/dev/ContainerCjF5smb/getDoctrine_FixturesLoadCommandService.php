...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/AddressFix.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/CategoryFix.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/DishFix.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/OrderDetails.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/OrderFix.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/PageFix.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/RestaurantFix.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ReviewFix.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AddressFix(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CategoryFix(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\DishFix(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\OrderDetails(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\OrderFix(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\PageFix(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\RestaurantFix(), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\ReviewFix(), 'groups' => []], 8 => ['fixture' => new \App\DataFixtures\UserFix(new \Symfony\Component\PasswordHasher\Hasher\UserPasswordHasher(($container->privates['security.password_hasher_factory'] ?? $container->load('getSecurity_PasswordHasherFactoryService')))), 'groups' => []]]);
